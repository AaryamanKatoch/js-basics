...
// time complexity is o(n) as all these functions use a for loop behind the scenes
//var array=[]; var reverse;
function palindrome(str) {
  let reversedarr=[];let reverse="";
str = str.toLowerCase();
let array = str.split("");
reversedarr = array.reverse();
reverse=reversedarr.join("");
if(str===reverse)
return true;
else
return false;
