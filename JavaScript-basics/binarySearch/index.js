...
let right= sortedArr[sortedArr.length-1]; let mid;
while(left<=right)
{
mid= Math.floor((left+right)/2);
if(mid==value)
return sortedArr.indexOf(mid);
else if(mid<value)
left=sortedArr[sortedArr.indexOf(mid)+1]
else
right=sortedArr[sortedArr.indexOf(mid)-1]
